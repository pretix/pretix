...
org_permission_sub_urls = [
    ...
    ('get', 'can_change_organizer_settings', 'devices/{team_id}/', 404),
    ('put', 'can_change_organizer_settings', 'devices/{team_id}/', 400),
    ('patch', 'can_change_organizer_settings', 'devices/{team_id}/', 404),
