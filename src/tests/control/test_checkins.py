...
@pytest.mark.parametrize("order_key, expected", [
    ...
    ('-order__code', ['A3Ticket', 'A2Ticket', 'A1Ticket', 'A1Mascot']),
    ('order__code', ['A1Ticket', 'A1Mascot', 'A2Ticket', 'A3Ticket']),
    ('-order__email', ['A3Ticket', 'A2Ticket', 'A1Ticket', 'A1Mascot']),
    ('order__email', ['A1Ticket', 'A1Mascot', 'A2Ticket', 'A3Ticket']),
    ('-checkins__id', ['A3Ticket', 'A1Ticket', 'A1Mascot', 'A2Ticket']),
    ('checkins__id', ['A1Mascot', 'A2Ticket', 'A1Ticket', 'A3Ticket']),
    ('-checkins__datetime', ['A1Ticket', 'A3Ticket', 'A1Mascot', 'A2Ticket']),  # A1 checkin date > A3 checkin date
    ('checkins__datetime', ['A1Mascot', 'A2Ticket', 'A3Ticket', 'A1Ticket']),
    ('-attendee_name', ['A3Ticket', 'A2Ticket', 'A1Ticket', 'A1Mascot']),
    ('attendee_name', ['A1Mascot', 'A1Ticket', 'A2Ticket', 'A3Ticket']),  # mascot doesn't include attendee name
    ('-item__name', ['A1Ticket', 'A2Ticket', 'A3Ticket', 'A1Mascot']),
    ('item__name', ['A1Mascot', 'A1Ticket', 'A2Ticket', 'A3Ticket'])
])
...
@pytest.mark.parametrize("query, expected", [
    ...
    ('status=&item=Ma&user=', ['A1Mascot']),
    ('status=&item=Ticket&user=', ['A1Ticket', 'A2Ticket', 'A3Ticket']),
...
@pytest.mark.parametrize("query, expected", [
    ...
    ('status=1&item=&user=&ordering=checkins__datetime', ['A3Ticket', 'A1Ticket']),
    ('status=0&item=&user=&ordering=-item__name', ['A2Ticket', 'A1Mascot']),
