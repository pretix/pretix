...
urlpatterns = [
    ...
    url(r'^event/(?P<organizer>[^/]+)/(?P<event>[^/]+)/', include([
        ...
        url(r'^orders/(?P<code>[0-9A-Z]+)/cancellationrequests/(?P<req>\d+)/ignore$',
            orders.OrderCancellationRequestIgnore.as_view(),
            name='event.order.cancellationrequests.ignore'),
