...
class DiscountForm(I18nModelForm):
    class Meta:
        ...
        field_classes = {
            ...
            'event_date_from': SplitDateTimeField,
            'event_date_until': SplitDateTimeField,
        ...
        widgets = {
            ...
            'event_date_from': SplitDateTimePickerWidget(),
            'event_date_until': SplitDateTimePickerWidget(attrs={'data-date-after': '#id_event_date_from_0'}),
