...
As with all event-level plugin signals, the ``sender`` keyword argument will contain the event. A ``request``
...
As with all event-level plugin signals, the ``sender`` keyword argument will contain the event. The
