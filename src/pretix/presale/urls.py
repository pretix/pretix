...
event_patterns = [
    ...
    re_path(r'^order/(?P<order>[^/]+)/(?P<secret>[A-Za-z0-9]+)/installment-recovery/$',
            pretix.presale.views.order.OrderInstallmentRecovery.as_view(),
            name='event.order.installment.recovery'),
