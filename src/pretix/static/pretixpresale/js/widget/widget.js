...
Vue.component('item', {
    template: ('<div v-bind:class="classObject" :data-id="item.id">'
        ...
        + '   v-bind:aria-expanded="expanded ? \'true\': \'false\'" v-bind:aria-controls="item.id + \'-variants\'">'
        + '<span v-if="!expanded" class="pretix-widget-collapse-indicator-right">' + strings.variations + '</span>'
        + '<span v-if="expanded" class="pretix-widget-collapse-indicator-down">' + strings.hide_variations + '</span>'
        + '</a>'
