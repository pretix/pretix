...
def _create_order(event: Event, email: str, positions: List[CartPosition], now_dt: datetime,
    ...
    with transaction.atomic():
        ...
        order = Order(
            ...
            require_approval=any(p.item.require_approval or p.variation.require_approval for p in positions),
...
class OrderChangeManager:
    ...
    def _create_split_order(self, split_positions):
        ...
        split_order.require_approval = self.order.require_approval and any(
            p.item.require_approval or p.variation.require_approval for p in split_positions)
        split_order.save()
