...
class SeatingPlan(LoggedModel):
    ...
    def iter_all_seats(self):
        ...
        # than 10'000 zones, less than 10'000 rows in every zone and no less than 10'0000 seats in every row.
        # Respectively, no row/seat numbers may be numeric with a value 10'0000. The resulting ranks *will* have gaps.
        # We chose this way over just sorting the seats and continuously enumerating them as an optimization, because
        # this way we do not need to update the rank of very seat if we change a plan a little.
