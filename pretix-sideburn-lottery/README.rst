...
Waiting-list lottery mechanics for Sideburn events: admin run/revert, rank
display, lottery-specific copy, and email placeholders.
...
This plugin has CI set up to enforce a few code style rules. To check locally,
