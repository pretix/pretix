...
RUN git clone https://github.com/pretix-unofficial/pretix-cliques.git && cd pretix-cliques && python setup.py install && python -m pretix migrate && python -m pretix rebuild
